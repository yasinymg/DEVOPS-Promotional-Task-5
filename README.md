...
![Public Security Group](screenshots/public_security_group.png)
![Private Security Group](screenshots/private_security_group.png)

### 8. Network ACL Configuration
![Public Subnet NACL](screenshots/public_subnet_nacl.png)
![Private Subnet NACL](screenshots/private_subnet_nacl.png)

### 9. EC2 Instance Deployment
![Public EC2 Instance](screenshots/public_ec2_instance.png)
![Private EC2 Instance](screenshots/private_ec2_instance.png)
